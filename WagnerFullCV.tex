...
\vspace{5pt}
\emph{2022}
\begin{etaremune}[start=120]

\item McCullough, I.M., Hanly, P.J., King, K.B.S., and \textbf{T. Wagner}. Accepted. Freshwater corridors in the conterminous US: a coarse-filter approach based on lake-stream networks. Ecosphere.
