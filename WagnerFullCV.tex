...
\vspace{5pt}
\emph{2018}
\begin{etaremune}[start=73]
\item Schal$^*$l, M.K., V.S. Blazer, R.M. Lorantas, G.D. Smith, J.E. Mullican, B.J. Keplinger, {\bf T. Wagner}. In press. Quantifying temporal trends in fisheries abundance using Bayesian dynamic linear models: A case-study of riverine smallmouth bass populations. North American Journal of Fisheries Management.
