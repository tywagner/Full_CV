...
\vspace{5pt}
\emph{2020}
\begin{etaremune}[start=100]
	
\item \textbf{Wagner, T.}, G.J.A. Hansen, E. Schliep, B. Bethke, A. Honsey, P. Jacobson, B.C. Kline, and S.L. White. Improved understanding and prediction of freshwater fish communities through the use of joint species distribution models. Canadian Journal of Fisheries and Aquatic Sciences.

\item Schall, M.K., G.D. Smith, V.S. Blazer, H.L. Walsh, Y. Li, and \textbf{T. Wagner}. Accepted. A fishery after the decline: The Susquehanna River Smallmouth Bass story. Fisheries.	
	
\item Stachelek, J. W. Weng, C.C. Carey, A.R. Kemanian, K.M. Cobourn, \textbf{T. Wagner}, K.C. Weathers, P.A. Soranno. Accepted. Granular measures of agricultural land-use influence lake nitrogen and phosphorus differently at macroscales. Ecological Applications.

\item Brennan, J.C., R.W. Gale, D.A. Alvarez, J.K. Leet, Y. Li, \textbf{T. Wagner}, D.E. Tillitt. Accepted. Factors affecting sampling strategies for design of an effects-directed analysis for endocrine-active chemicals. Environmental Toxicology and Chemistry.

\item McClure$^*$, C.M., K.L. Smalling, V.S. Blazer, A.J. Sperry, M.K. Schall, D.W. Kolpin, P.J. Phillips, M.L. Hladik, and \textbf{T. Wagner}. Accepted. Spatiotemporal variation in occurrence and co-occurrence of pesticides, hormones, and other organic contaminants in rivers in the Chesapeake Bay Watershed, United States. Science of The Total Environment.

\item  White$^\dagger$, S.L., E.M. Hanks, and \textbf{T. Wagner}. Accepted. A novel quantitative framework for riverscape genetics. Ecological Applications.
...
\item Soranno, P.A., K.S. Cheruvelil, B. Liu, Q. Wang, P-N. Tan, J. Zhou, K.B.S. King, I.M. McCullough, J. Stachelek, M. Bartley, C.T. Filstrup, E.M. Hanks, J-F. Lapierre, N.R. Lottig, E.M. Schliep, \textbf{T. Wagner}, K.E. Webster. Accepted. Ecological prediction at macroscales using big data: Does sampling design matter? Ecological Applications. 
...
% GRANTS
\centerline {\bf{GRANTS (over \$10,000,000 in total funding)}}
\vspace{5pt}
\begin{etaremune}
...
\centerline {\bf{CODE AND DATA PRODUCTS }}
\vspace{5pt}
\begin{etaremune}
	\item Massie, D. et al. (graduate student). Power Analysis: First release of framework developed in Massie et al. 2020. R scripts for performing power analysis for macroscale fish growth investigations. https://doi.org/10.5281/zenodo.3610495
	\item McClure, C. (graduate student). Contaminant occurrence: Code for Bayesian hierarchical joint-contaminant model. https://doi.org/10.5281/zenodo.3746590
	\item Wagner, T. Analysis of groundwater and surface water contaminants in rivers in the Chesapeake Bay Watershed. Data and model code. https://doi.org/10.5281/zenodo.3888674
	\item Hansen, Gretchen J A; Bethke, Bethany J; Ahrenstorff, Tyler D; Dumke, Josh; Hirsch, Jodie; Kovalenko, Katya E; LeDuc, Jaime F; Maki, Ryan P; Rantala, Heidi M; Wagner, Tyler. 2019. Data and R code for analysis of walleye and yellow perch age-0 length in Minnesota's Large Lakes. Retrieved from the Data Repository for the University of Minnesota, https://doi.org/10.13020/t9tr-y063.
\item Wagner T. 2019. Updated release of code and data for Wagner et al., includes new code and metadata (Version v1.2.0). http://doi.org/10.5281/zenodo.3484680
	
\item Wagner, T. 2019. txw19/Eco\_variation: Spatial and temporal variation of ecosystem properties at macroscales (Version v1.0.0). Zenodo. http://doi.org/10.5281/zenodo.2628379
\end{etaremune}	
