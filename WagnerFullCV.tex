...
\item Massie$^*$, D.L.,  Y. Li, and \textbf{T. Wagner}. A framework for detecting macroscale drivers on fish growth. Accepted. Canadian Journal of Fisheries and Aquatic Sciences. 

\item Thompson$^*$, T.J., M.A. Briggs, P.J. Phillips, V.S. Blazer, K.L. Smalling, D.W. Kolpin, \textbf{T. Wagner}. Groundwater discharges as a source of phytoestrogens and other agriculturally derived contaminants to streams. Science of the Total Environment.
