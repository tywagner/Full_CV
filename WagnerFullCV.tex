...
\vspace{5pt}
\emph{2020}
\begin{etaremune}[start=94]
	
\item White$^\dagger$, S., D. DeMario$^*$, L. Iwanowicz, V. Blazer, and \textbf{T. Wagner}. Accepted. Tissue distribution and immunomodulation in channel catfish (Ictalurus punctatus) following dietary exposure to polychlorinated biphenyl Aroclors and food deprivation. International Journal of Environmental Research and Public Health.
...
\item \textbf{Wagner, T.$^\star$}, N.R. Lottig$^\star$, M.L. Bartley, E.M. Hanks, E.M. Schliep, N.B. Wikle, K.B.S. King, I. McCullough, J. Stachelek, K.S. Cheruvelil, C.T. Filstrup, J.F. Lapierre, B. Liu, P.A. Soranno, P-N. Tan, Q. Wang, K. Webster, and J. Zhou. Accepted. Increasing accuracy of lake nutrient predictions in thousands of lakes by leveraging water clarity data. Limnology and Oceanography Letters. 

\item Bartley, M.L., E.M. Hanks, E.M. Schliep, P.A. Soranno, and \textbf{T. Wagner}. Accepted. Identifying and characterizing extrapolation in multivariate response data. PLOSE ONE.

\item White$^\dagger$, S., E. Faulk, C. Tzilkowski, A.S. Weber, M. Marshall, and \textbf{T. Wagner}. Accepted. Predicting fish species richness and habitat relationships using Bayesian hierarchical multispecies occupancy models. Canadian Journal of Fisheries and Aquatic Sciences.
...
\item Schall$^*$, M.K., T. Wertz, G.D. Smith, V.S. Blazer, and \textbf{T. Wagner}. In press. Movement dynamics of smallmouth bass (Micropterus dolomieu) in a large river-tributary system. Fisheries Management and Ecology.	
...
% GRANTS
\centerline {\bf{GRANTS (over \$9,000,000 in total funding)}}
\vspace{5pt}
\begin{etaremune}
