...
\vspace{5pt}
\emph{2017}
\begin{etaremune}[start=65]
\item Hansen, G.J.A., S.R. Midway, {\bf T. Wagner}. in press. Walleye recruitment is less resilient to warming water temperatures in lakes with abundant largemouth bass populations. Canadian Journal of Fisheries and Aquatic Sciences.

\item Grossman, G.D., R.F. Carline, and {\bf T. Wagner}. Brown trout (\emph{Salmo trutta}) in Spruce Creek Pennsylvania: a quarter-century perspective. In press. Freshwater Biology.

\item Collins, S.M., S.K. Oliver, J.F. Lapierre, E.H. Stanley, J.R. Jones, {\bf T. Wagner}. and P.A. Soranno. 2017. Lake nutrient stoichiometry is less predictable than nutrient concentrations at regional and sub-continental scales. Ecological Applications.
...
\item Sweka, J.A., L.A. Davis, {\bf T. Wagner}. In press. Fall and winter survival of brook and brown trout in a North-Central Pennsylvania watershed. Transactions of the American Fisheries Society.

\item Cheruvelil, S. K., S. Yuan, K.E. Webster, P-N Tan, J.F. Lapierre, S.M. Collins, C.E. Fergus, C.E. Scott, E.N. Henry, P.A. Soranno, C.T. Filstrup, {\bf T. Wagner}. In press. Creating multi-themed ecological regions for macrosystems ecology: Testing a flexible, repeatable, and accessible clustering method. Ecology and Evolution.

\item {\bf Wagner}, T. J.B. Whittier, J.T. DeWeber, S.R. Midway, and C.P. Paukert. In press. Annual changes in seasonal river water temperatures in the eastern and western United States. Water.

\item Peoples, B., S.R. Midway, J.T. DeWeber, and {\bf T. Wagner}. In press. Catchment scale determinants of nonindigenous minnow richness in the eastern United States. Ecology of Freshwater Fish.

\item Midway, S.R., C.T. Hasler, {\bf T. Wagner}, and C.D. Suski. In press. Predation of freshwater fish in elevated carbon dioxide environments. Marine and Freshwater Resources.

\item White$^*$, S.L., {\bf T. Wagner}, C. Gowand, and V.A. Braithwaite. In press. Can personality predict individual differences in brook trout spatial learning ability? Behavioural Processes. 
...
% GRANTS
\centerline {\bf{GRANTS (over \$8,149,000 in total funding)}}
\vspace{5pt}
\begin{etaremune}
...
\item {\sl  U.S. Geological Survey},  Chesapeake Bay Priority Ecosystems Science: Linking fish health, contaminants, and population dynamics of smallmouth bass populations in the Susquehanna River, Pennsylvania; PI: Tyler Wagner. May 2013 - May 2019; Total: \$240,000; Amount to Wagner: \$240,000
