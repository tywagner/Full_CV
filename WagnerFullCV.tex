...
\vspace{5pt}
\emph{2018}
\begin{etaremune}[start=80]
\item Li$^\dagger$, Y., V.S. Blazer, and \textbf{T. Wagner}. In press. Quantifying population-level effects of water temperature, flow velocity and chemical-induced reproduction depression: a simulation study with smallmouth bass. Ecological Modeling.
