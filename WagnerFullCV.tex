...
\vspace{5pt}
\emph{2017}
\begin{etaremune}[start=62]
\item Vidal, T. E., B. J. Irwin, T. Wagner, L. G. Rudstam, J. R. Jackson, and J. R. Bence. Accepted. Using Variance Structure to Quantify Responses to Perturbation in Fish Catches. Transactions of the American Fisheries Society.
...
\item Cheruvelil, S. K., S. Yuan, K.E. Webster, P-N Tan, J.F. Lapierre, S.M. Collins, C.E. Fergus, C.E. Scott, E.N. Henry, P.A. Soranno, C.T. Filstrup, {\bf T. Wagner}. Accepted. Creating multi-themed ecological regions for macrosystems ecology: Testing a flexible, repeatable, and accessible clustering method. Ecology and Evolution.
...
% GRANTS
\centerline {\bf{GRANTS (over \$8,125,000 in total funding)}}
\vspace{5pt}
\begin{etaremune}
