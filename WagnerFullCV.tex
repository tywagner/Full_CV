...
\item \textbf{Wagner, T.}, McLaughlin$^\dagger$, P., Smalling, K., Breitmeyer, S., Gordon, S., and Noe, G.B., Accepted. The statistical power to detect regional temporal trends in riverine contaminants in the Chesapeake Bay Watershed, USA. Science of the Total Environment.

\item Sweka, J.A. and \textbf{T. Wagner}. Accepted. Influence of seasonal extreme flows on Brook Trout recruitment. Transactions of the American Fisheries Society.

\item Qui, Q., Y. Xu, S.S. Matsuzaki, K. Komatsu, Z. Liang, \textbf{T. Wagner}. Accepted. A framework to track time dependence of chlorophyll–nutrient relationships: implications for lake eutrophication management. Journal of Hydrology.
...
% GRANTS
\centerline {\bf{GRANTS (over \$11,500,000 in total funding)}}
\vspace{5pt}
\begin{etaremune}
